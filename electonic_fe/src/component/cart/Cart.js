                        ...
                        <div className="col-lg-3">
                            ...
                            <div className="card shadow-0 border">
                                <div className="card-body">
                                    ...
                                    <div className="mt-3">
                                        <a href="src/component#" className="btn btn-success w-100 shadow-0 mb-2">
                                            {" "}
                                            Make Purchase{" "}
                                        </a>
                                        <a href="src/component#" className="btn btn-light w-100 border mt-2">
                                            {" "}
                                            Back to shop{" "}
                                        </a>
                                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card px-4 border shadow-0 mb-4 mb-lg-0">
                                ...
                                <a href="src/component#" className="">
                                    <img
